...
const music = new Audio('./songs/arjit_audio/1.mp3');
//music.play();
...
//Array.from(document.getElementById('playListPlay'))
		...
		poster_master_play.src = `./image/arjit_img/${index}.jpg`;
		music.play();
		document.getElementById('master_Play').classList.remove('bi-play-fill');
		document.getElementById('master_Play').classList.add('bi-pause-fill');
	  document.getElementById('wave').classList.add('active2');
...
back.addEventListener('click',()=>{
	...
	music.src = `songs/arjit_audio/${index}.mp3`;
		...
		makeAllBackgrounds();
		Array.from(document.getElementsById('songItem')).style.background = 'rgb(105, 105, 170, .1)';
    makeAllPlays();
    el.target.classList.add('bi-pause-circle-fill');
    el.target.classList.remove('bi-play-circle-fill');
    document.getElementById('wave').classList.add('active2');
